...
class TreeBillboardsScene
{
public:
	TreeBillboardsScene(std::shared_ptr<tiny::DeviceResources> deviceResources);
...
private:
	...
	std::unique_ptr<tiny::ConstantBufferT<treebillboards::PassConstants>> m_mainRenderPassConstantsCB = nullptr;
	...
	std::unique_ptr<treebillboards::Waves> m_waves;
	tiny::DynamicMeshGroupT<treebillboards::Vertex>* m_dynamicWaveMesh = nullptr;
	...
	// Tree Sprites
	std::unique_ptr<tiny::Shader> m_treeSpriteVS = nullptr;
	std::unique_ptr<tiny::Shader> m_treeSpriteGS = nullptr;
	std::unique_ptr<tiny::Shader> m_treeSpritePS = nullptr;
	std::unique_ptr<tiny::InputLayout> m_treeSpriteInputLayout = nullptr;

	std::unique_ptr<tiny::RasterizerState> m_treeSpriteRasterizerState = nullptr;
	std::unique_ptr<tiny::BlendState> m_treeSpriteBlendState = nullptr;
	std::unique_ptr<tiny::DepthStencilState> m_treeSpriteDepthStencilState = nullptr;

	std::unique_ptr<GameObject> m_treeSpritesObject = nullptr;
